...
public class QuizData3 extends AppCompatActivity {
    int qCounter=4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_data3);
        ...
        Random r=new Random();
        randomNumber=r.nextInt(mouth.length);
        i_alpha=	mouth[randomNumber]; //saving in string
            ...
            public void onClick(View v) {
                if(answered==false)
                {
                    if(rb1.isChecked()||rb2.isChecked()||rb3.isChecked())
                    {
                        ...
                        Intent intt=new Intent(QuizData3.this,QuizData4.class);
                        intt.putExtra("score",s);
                        intt.putExtra("question_left",qCounter);
                        startActivity(intt);
                    }
                    else{
                        Toast.makeText(QuizData3.this,"please select an option",Toast.LENGTH_SHORT).show();
                    }
                }else
                {
